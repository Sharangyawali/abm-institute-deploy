...
export const userVerifiedMail = async (name,email,role,password) => {
...
const generateEmailTemplate = (name,role,password) => {
  ...
  return `
    ...
    <div class="content">
        <p>Dear ${name},</p>
        <p>Your request as a ${role} in ABM Institute has been successfully verified.</p>
        <p>Your password for the account is set as:<strong>${password}</strong></p>
