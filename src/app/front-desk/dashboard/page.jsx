...
const page = () => {
  ...
  const getAllUsers=async()=>{
    let result = await fetch("http://localhost:3000/api/front-desk/visitors", {
      method: "get",
    });
  ...
  const getLatestUsers=async()=>{
    let result = await fetch("http://localhost:3000/api/front-desk/getLatestVisitors", {
      method: "get",
    });
    result = await result.json();
    if (result.success === false) {
  ...
  const getMaxUsers=async()=>{
    let result = await fetch("http://localhost:3000/api/front-desk/getMaxVisitors", {
      method: "get",
    });
    result = await result.json();
    if (result.success === false) {
