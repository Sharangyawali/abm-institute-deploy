...
const page = () => {
  ...
  const getDetail = async () => {
    ...
    if (result.success === false) {
      ...
      setSelectedImage(result.detail.frontDesk.profilePic)
      setStreetAddress(result.detail.frontDesk.streetAddress ?? "");
      setCity(result.detail.frontDesk.city ?? "");
      setState(result.detail.frontDesk.state ?? "");
      setGender(result.detail.frontDesk.gender ?? "Male");
    }
  };
        ...
        <div className="w-[100%] tablet:w-[80%] flex flex-col laptop:flex-row justify-between items-center">
          ...
          <div className="w-[100%] laptop:w-[59%] flex flex-col h-[600px] shadow-xl rounded-md justify-evenly px-[10px] ">
            ...
            <div className="w-[100%] flex justify-center  text-[18px] font-semibold ">
              <div
                className="text-white bg-[#5a215a] flex justify-center items-center w-[90px] h-[40px] rounded-sm cursor-pointer hover:bg-[#a540a5]"
