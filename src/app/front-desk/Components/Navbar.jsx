...
const Navbar = () => {
  return (
    ...
    <div className="h-[100%] w-[100%] tablet:w-[95%] laptop:w-[80%]  flex laptop:justify-between items-center">
      <div className="flex w-[50%]  flex-col laptop:flex-row ">
        ...
        {/* content topics */}
        <div className="h-[40px] laptop:w-[45%] flex laptop:gap-[20px] laptop:ml-[40px] items-center laptop:justify-evenly  text-[#777777] laptop:text-black font-normal">
        <div className="stationery flex mr-[15px] laptop:mr-0 hover:text-secondary-color font-semibold dark:hover:text-primary-color items-center cursor-pointer">
            <Link href='/front-desk/dashboard'> Dashboard</Link>
          </div>
          <div className="books  flex mr-[15px] laptop:mr-0 hover:text-secondary-color font-semibold dark:hover:text-primary-color items-center cursor-pointer">
            <Link href="/front-desk/addVisitors"> Add Visitors</Link>
          </div>
        </div>
      </div>
