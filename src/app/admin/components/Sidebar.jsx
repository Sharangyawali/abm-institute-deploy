...
const Sidebar = ({show}) => {
  ...
  return (
    ...
    ''
              ...
              <Link href='/insight' className={pathName==='/insight'?"flex items-center w-full h-10 px-3 mt-2 rounded text-[#272727] bg-gray-300":"flex items-center w-full h-10 px-3 mt-2 rounded hover:text-[#272727] hover:bg-gray-300"} >
      <HiOutlineChartSquareBar className='w-[25px] h-[25px]' color='black'/>
      {show===true?
