...
:
    <div className='w-[95%] h-[750px] bg-white flex flex-col'>
        ...
        <div className=' w-[100%] mt-[30px] h-[570px] flex flex-col items-center  overflow-y-auto scrollbar-thin  scrollbar-thumb-[#420177] scrollbar-track-[#EBCBF5] '>
            {visitor.transaction.length>0?
            visitor.transaction.map((pay,index)=>{
                ...
                return(
                    ...
                    <div className='inline-block font-mono text-[18px] capitalize'>{pay.type} Time:<div className='inline-block text-[#585858] text-[16px] ml-[8px]'>
                    {formattedDate}
                        </div> </div>
                        <div className='flex flex-col'>
