...
const getEmployeeDetail = async () => {
  ...
  return (
    <div className='w-[100%] h-[830px] bg-[#f0f0f0] flex flex-col laptop:p-[40px] items-center laptop:justify-center'>
    {loading?
    <CircularProgress/>
:
    <div className='w-[100%] laptop:w-[95%] h-[750px] bg-white flex flex-col'>
        <div className='w-[100%] h-[130px] bg-white border-y-[2px] border-[#f0f0f0] flex justify-between items-center tablet:px-[50px] laptop:px-[100px]'>
        ...
        <div className=' w-[100%] mt-[30px] h-[570px] flex flex-col items-center  overflow-y-auto scrollbar-thin  scrollbar-thumb-[#420177] scrollbar-track-[#EBCBF5] '>
            ...
            salary.map((sal,index)=>{
                ...
                return(
                    <div className=' w-[100%] laptop:w-[80%] rounded-2xl bg-[#f0f0f0] h-[100px] flex justify-between tablet:px-[50px] laptop:px-[100px] items-center mb-[20px]' key={index}>
