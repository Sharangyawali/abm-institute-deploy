...
import {
  setLoadingFalse,
  setLoadingTrue,
} from "@/store/loadingShow/loadingShow";
  ...
  return (
    <div className="w-[100%] flex justify-center items-center">
      <div className="w-[100%] laptop:w-[90%] h-[800px]  flex flex-col justify-start  shadow-2xl">
        ...
        <div className="w-[100%] h-[700px]  laptop:px-[10px] overflow-x-scroll scrollbar-thin  scrollbar-thumb-[#420177]">
          <table className="w-[100%] text-sm text-gray-500 ">
            <thead className=" text-xs text-gray-700 uppercase bg-[#f3f3f3]">
              <tr className="flex w-full">
                <th className="flex items-center justify-center px-4 py-2 w-[12%]">
                  SN
                </th>
                <th className="flex items-center justify-center px-4 py-2 w-[12%]">
                  Name
                ...
                <th className="flex items-center justify-center px-4 py-2 w-[15%]">
                  Address
                </th>
                <th className="flex items-center justify-center px-4 py-2 w-[12%]">
                  Email
                </th>
                <th className="flex items-center justify-center px-4 py-2 w-[14%]">
                  Password
                </th>
                <th className="flex items-center justify-center px-4 py-2 w-[10%]"></th>
              </tr>
            </thead>
            <tbody className="text-xs  flex flex-col h-[650px] overflow-y-scroll scrollbar-thin scrollbar-thumb-[#420177]">
                    ...
                    return (
                      ...
                      >
                        <td
                          ...
                          onClick={() => {
                            router.push(`/admin/staff/accountant/${acc.id}`);
                          }}
                        >
                          {index + 1}
                        </td>
                        ...
                        <td
                          className="flex items-center justify-center px-4 py-2 w-[15%]"
                          onClick={() => {
                            router.push(`/admin/staff/accountant/${acc.id}`);
                          }}
                        >
                        ...
                        <td className="flex items-center justify-center px-4 py-2 w-[15%]">
                          <div
                            className="bg-[#783e99] min-w-[90%] h-[160%] text-white flex justify-center items-center cursor-pointer hover:bg-[#ad42eb]"
                            onClick={() => {
                              changePassword(acc);
                              setIsModalOpen(true);
                        ...
                        <td className="flex items-center justify-center px-4 py-2 w-[10%]">
                          <MdDelete
                            size={24}
                            color="red"
                    ...
                    return (
                      ...
                      >
                        <td
                          className="flex items-center justify-center px-4 py-2 w-[12%]"
                          onClick={() => {
                            router.push(`/admin/staff/teacher/${acc.id}`);
                          }}
                        >
                          {index + 1}
                        </td>
                        ...
                        <td className="flex items-center justify-center px-4 py-2 w-[14%]">
                          <div
                            className="bg-[#783e99] w-[90%] h-[40px] text-white flex justify-center items-center cursor-pointer hover:bg-[#ad42eb]"
                            onClick={() => {
                              changePassword(acc);
                              setIsModalOpen(true);
                              setPasswordModal(true);
                    ...
                    return (
                      ...
                      >
                        <td
                          className="flex items-center justify-center px-4 py-2 w-[12%]"
                          onClick={() => {
                            router.push(`/admin/staff/frontDesk/${acc.id}`);
                          }}
                        >
                          {index + 1}
                        </td>
                        ...
                        <td className="flex items-center justify-center px-4 py-2 w-[14%]">
                          <div
                            className="bg-[#783e99] w-[90%] h-[160%] text-white flex justify-center items-center cursor-pointer hover:bg-[#ad42eb]"
                            onClick={() => {
                              changePassword(acc);
                              setIsModalOpen(true);
                              setPasswordModal(true);
            ...
            {user ? (
              <>
                <div className="bg-[#f0f0f0] p-[15px] text-[15px] font-sans">
                  ...
                  <strong>{user.user.role} </strong> in ABM Institute with phone
                  number
                  <strong> {user.phone}</strong>
                  and email
                  <strong> {user.email}</strong> ? If so click the button down
                  here to delete the account!!
                </div>
                <div className="bg-white px-[10px]">
                  <div
                    className="w-[150px] my-[15px] h-[30px] flex items-center justify-center bg-[#a25dda] font-semibold text-white float-end rounded-lg cursor-pointer"
